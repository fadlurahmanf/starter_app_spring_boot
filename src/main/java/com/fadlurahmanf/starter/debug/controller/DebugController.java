...
public class DebugController {
    ...
    public String updateBalance(@RequestBody JSONObject jsonObject){
    ...
    public String tesRabbitMq(@RequestBody JSONObject jsonObject){
    ...
    public String testFcm(@RequestBody JSONObject jsonObject){
    ...
    public String testPutCacheRedis(@RequestBody JSONObject jsonObject){
    ...
    public String testGetCacheRedis(@RequestBody JSONObject jsonObject){
        String userId = jsonObject.getString("userId");
    ...
    public String testRedisLock(@RequestBody JSONObject jsonObject){
        try {
